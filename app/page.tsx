...
function LiveDataSection() {
  return (
    <AnimatedSection className="relative py-16 sm:py-20 px-4 sm:px-6">
      <div className="max-w-[1200px] mx-auto">
        <div className="mb-10">
          <span className="terminal-prompt font-[family-name:var(--font-mono)] text-sm text-white/70">live-data</span>
          <h2 className="mt-4 font-[family-name:var(--font-heading)] text-2xl sm:text-3xl md:text-4xl font-bold text-white">
            Real-time <span className="gradient-text">Intelligence</span>
          </h2>
          <p className="mt-3 text-white/60 max-w-2xl">
            Live data feeds from space, crypto markets, and satellite tracking — updated in real-time.
          </p>
        </div>
...
function ProjectsSection() {
  const projects = [
    {
      ...
      description: "Dark-luxury developer portfolio with real-time data feeds, interactive tools, and space tracking.",
      tech: ["Next.js 15", "TypeScript", "Framer Motion", "Tailwind"],
      gradient: "from-[var(--accent-cyan)] to-[var(--accent-purple)]",
      link: "/",
    },
    {
      title: "Ouija Platform",
      description: "Full-stack SaaS with authentication, payments, and dark-luxury UI built on modern monorepo architecture.",
      tech: ["React", "Node.js", "Gleam", "PostgreSQL"],
      gradient: "from-purple-500 to-pink-500",
      link: "#",
    },
    {
      title: "Obsidian Echoes",
      description: "Terminal mystery concept exploring interactive storytelling through command-line interfaces.",
      tech: ["TypeScript", "Terminal UI", "Interactive Fiction"],
  ...
  return (
    <AnimatedSection className="relative py-24 sm:py-32 px-4 sm:px-6">
      <div className="max-w-[1200px] mx-auto">
        <div className="mb-12">
          <span className="terminal-prompt font-[family-name:var(--font-mono)] text-sm text-white/70">featured-work</span>
          <h2 className="mt-4 font-[family-name:var(--font-heading)] text-2xl sm:text-3xl md:text-4xl font-bold text-white">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project, i) => (
            ...
            >
              <div className={`w-full h-32 rounded-lg bg-gradient-to-br ${project.gradient} opacity-20 group-hover:opacity-30 transition-opacity duration-500 mb-4`} />
              ...
              <div className="flex flex-wrap gap-2">
                {project.tech.map((tech) => (
                  <span key={tech} className="text-xs px-2 py-1 rounded bg-white/[0.05] text-white/70 font-[family-name:var(--font-mono)]">
                    {tech}
                  </span>
                ))}
              </div>
...
function StackSection() {
  const stack = {
    ...
    "DevOps": ["Docker", "Vercel", "GitHub Actions", "Cloudflare"],
    "Tools": ["VS Code", "Figma", "Git", "Linear", "Postman"],
  };

  return (
    <AnimatedSection className="relative py-24 sm:py-32 px-4 sm:px-6 bg-black/20">
      <div className="max-w-[1200px] mx-auto">
        <div className="mb-12 text-center">
          <span className="terminal-prompt font-[family-name:var(--font-mono)] text-sm text-white/70">tech-stack</span>
          <h2 className="mt-4 font-[family-name:var(--font-heading)] text-2xl sm:text-3xl md:text-4xl font-bold text-white">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {Object.entries(stack).map(([category, items], i) => (
            ...
            >
              <h3 className="text-sm font-bold text-white mb-4 font-[family-name:var(--font-mono)] uppercase tracking-wider">
                {category}
              </h3>
              <div className="space-y-2">
                {items.map((item) => (
  ...
  return (
    <AnimatedSection className="relative py-24 sm:py-32 px-4 sm:px-6">
      <div className="max-w-[800px] mx-auto text-center">
        <span className="terminal-prompt font-[family-name:var(--font-mono)] text-sm text-white/70">get-in-touch</span>
        <h2 className="mt-4 font-[family-name:var(--font-heading)] text-2xl sm:text-3xl md:text-4xl font-bold text-white">
        ...
        <div className="mt-10 flex flex-wrap gap-4 justify-center">
          <motion.div whileHover={{ scale: 1.05, y: -2 }} whileTap={{ scale: 0.97 }}>
            <a href="mailto:mnixon112@outlook.com" className="glow-btn glow-btn-filled">
              <span>Email Me</span>
      ...
      <div className="max-w-[1200px] mx-auto">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="text-center sm:text-left">
            <div className="text-white font-[family-name:var(--font-heading)] font-bold text-lg mb-1">
              Maxwell Nixon
            </div>
            <div className="text-white/50 text-sm font-[family-name:var(--font-mono)]">
              Full-Stack Engineer · Southampton, NJ
            </div>
          </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <a href="mailto:mnixon112@outlook.com" className="text-white/60 hover:text-white transition-colors">
        ...
        <div className="mt-8 pt-8 border-t border-white/[0.06] text-center">
          <p className="text-white/40 text-xs font-[family-name:var(--font-mono)]">
            © {new Date().getFullYear()} Maxwell Nixon. Built with Next.js 15 · Powered by real-time APIs
          </p>
        </div>
      </div>
    </footer>
